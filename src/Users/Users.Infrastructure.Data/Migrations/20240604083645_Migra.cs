    ...
    public partial class Migra : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MapPointWithUsers", x => new { x.UserId, x.PointId });
                    table.ForeignKey(
                        name: "FK_MapPointWithUsers_MapPoints_PointId",
                        column: x => x.PointId,
                        principalTable: "MapPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MapPointWithUsers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MapPointWithUsers_PointId",
                table: "MapPointWithUsers",
                column: "PointId");
